    ...
    public static partial class EzyNetwork
    {
        ...
        public static void JoinLobby(int lobbyId, bool subscriberChat, Action<JoinLobbyOperationResponse> onResponse = null)
        {
            peer.JoinLobby(lobbyId, response => {
                if (response.Success) if (subscriberChat) peer.SubscriberChatLobby(subscriberChat, null);
        ...
        //public static void LeaveLobby(Action<OperationResponse> onResponse = null)
        //{
        ...
        {
            peer.CreateGameObjectRoom(prefabPath, initializeData, synchronizationData, onResponse);
        }
        ...
        {
            if (targets == EzyTargets.OnlyMe || targets == EzyTargets.All || (targets == EzyTargets.LeaderClient && EzyNetwork.IsLeaderClient))
            {
